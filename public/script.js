...
//TEMPERATURE GRAPH
Plotly.plot('temperatureGraph', [{ y: [], type: 'line', line:{color:'#5C64B7'} ,fill:'tozeroy', fillcolor: 'rgba(92, 100, 183,0.3)'}], layout={plot_bgcolor:'white',
paper_bgcolor:'white', margin: { t: 40, b: 30, l: 40, r: 0 }});
//PRESSURE GRAPH
Plotly.plot('pressureGraph', [{ y: [], type: 'line' ,line:{color:'#5C64B7'} ,fill:'tozeroy', fillcolor: 'rgba(92, 100, 183,0.3)'}], layout={plot_bgcolor:'white',
paper_bgcolor:'white', margin: { t: 40, b: 30, l: 40, r: 0 }});
Plotly.plot('altitudeGraph', [{ y: [], type: 'line' , line:{color:'#5C64B7'} ,fill:'tozeroy', fillcolor: 'rgba(92, 100, 183,0.3)'}], layout={plot_bgcolor:'white',
paper_bgcolor:'white', margin: { t: 40, b: 30, l: 40, r: 0 }});
//VOLTAGE
Plotly.plot('voltageGraph', [{ y: [], type: 'line' , line:{color:'#5C64B7'} ,fill:'tozeroy', fillcolor: 'rgba(92, 100, 183,0.3)'}], layout={plot_bgcolor:'white',
paper_bgcolor:'white', margin: { t: 40, b: 30, l: 40, r: 0 }});
...
updateMap(data);
    ...
    document.querySelector('#TiltXValue').textContent=`${data.TILT_X},${data.TILT_Y}`;
    ...
    document.querySelector('#GPSLongiValue').textContent=`${data.GPS_LATITUDE},${data.GPS_LONGITUDE}`
